  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 ease-out-expo focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // Fintech variants
        vault:
          "gradient-vault text-accent-foreground shadow-lg shadow-vault/20 hover:shadow-vault/30 hover:brightness-110",
        accent:
          "bg-accent text-accent-foreground shadow-sm hover:bg-accent/90",
        premium:
          "gradient-hero text-primary-foreground shadow-lg hover:shadow-xl",
        success:
          "bg-success text-success-foreground shadow-sm hover:bg-success/90",
        warning:
          "bg-warning text-warning-foreground shadow-sm hover:bg-warning/90",
        glass:
          "glass border border-border/50 text-foreground shadow-sm hover:bg-card/90",
      },
      size: {
